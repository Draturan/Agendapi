    ...
    switch($_GET['mode']){
        case "elimina":
            ...
            if(isset($_GET['id']) && $_GET['id'] != ""){
                $prestito_by_id = Libro::getLibroByID($_GET['id']);
                if(is_object($prestito_by_id)){
                    $risultato = "";
                    $controllo = $prestito_by_id->controlloLibro();
                    if ($controllo === true) {
                        $risultato = $prestito_by_id->deleteLibro();
                    } else {
                        $risultato = $controllo;
                    }
                    ...
                    $errori[] = $prestito_by_id[Libro::ERRORE];
                }
            }
            break;
        default:
