...
if($controllo === true){
    ...
    if(is_object($libro_sel)){
        ...
        if(is_object($utente_sel)){
            ...
            if(key($risultato) == Prestito::SUCCESSO){
                ...
                // mostro messaggio
                echo json_encode(array("message" => Prestito::SUCC_INS_PREST_MES));
            }else{
    ...
    echo json_encode(array("message" => "Impossibile creare il prestito: ".array_shift($controllo[Prestito::ERRORE])));
}